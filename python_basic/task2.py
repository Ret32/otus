    ...
    case "2":
        ...
        for a in range(count_line):
            ...
            for b in range(count_seats):
                enter_sits = int(input(f'Ввод бронирования. Ввод осуществляется поочередно по каждому сидению в каждом ряду в виде\n'
                                       f'одиночного параметра 0 или 1 (0-место свободно, 1-место занято).\n'
                                       f'Подтверждение через клавишу "Enter"\n'
                                       f'Введите бронирование сидений в ряду {a}, № сидения - {b}: '))
